...
[![Platform](https://img.shields.io/badge/Cloud-阿里云ECS-orange)](https://www.aliyun.com/)
[![OS](https://img.shields.io/badge/OS-Alibaba%20Cloud%20Linux%20%7C%20CentOS%207-blue)](https://www.centos.org/)
[![K8s](https://img.shields.io/badge/Kubernetes-本地%20Docker%20Desktop-brightgreen)](https://kubernetes.io/)
[![Ansible](https://img.shields.io/badge/Ansible-自动化部署-red)](https://www.ansible.com/)
> 从零构建的 DevOps 全栈运维平台：代码托管 → 自动化部署 → 容器编排 → 缓存加速 → 监控告警。
> 完整覆盖系统运维核心技能，所有模块均有实际代码和截图佐证。
